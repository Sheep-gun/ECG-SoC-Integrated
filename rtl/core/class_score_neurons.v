        ...
        if (rst) begin
            ...
            if (c24_segment_delta_pending) begin
                ...
                if (c24_apply_delta_pending) begin
                    ...
                    c24_mem_nsr <= c24_mem_nsr + c24_apply_delta_nsr + c24_segment_delta_nsr_reg;

                    c24_mem_chf <= c24_mem_chf + c24_apply_delta_chf + c24_segment_delta_chf_reg;

                    c24_mem_arr <= c24_mem_arr + c24_apply_delta_arr + c24_segment_delta_arr_reg;

                    c24_mem_aff <= c24_mem_aff + c24_apply_delta_aff + c24_segment_delta_aff_reg;

                end else begin

                    c24_mem_nsr <= c24_mem_nsr + c24_segment_delta_nsr_reg;

                    c24_mem_chf <= c24_mem_chf + c24_segment_delta_chf_reg;

                    c24_mem_arr <= c24_mem_arr + c24_segment_delta_arr_reg;

                    c24_mem_aff <= c24_mem_aff + c24_segment_delta_aff_reg;
                ...
                if (c24_apply_delta_pending) begin
                    ...
                    c24_mem_nsr <= c24_mem_nsr + c24_apply_delta_nsr;

                    c24_mem_chf <= c24_mem_chf + c24_apply_delta_chf;

                    c24_mem_arr <= c24_mem_arr + c24_apply_delta_arr;

                    c24_mem_aff <= c24_mem_aff + c24_apply_delta_aff;
            ...
            end else if (c24_segment_delta_pending) begin
