...
Digital commit `6298a8e030d45da6d989fec6ccccd74714070ee9`의 Nexys A7-100T 36-case 실보드 결과와 Vivado power report를 반영했다. Board-Golden 정합은 final prediction 36/36과 Final Membrane 144/144다. Active-core는 `profile_total-profile_input_wait`로 3,601,290 cycles, 36.012900 ms이며 Exact C++ 대비 49.362861641×다. UART-paced raw interval 187,144.750920 ms는 transport diagnostic으로만 보존하며 integrated-system compute latency/speedup/energy는 미측정이다. 성능과 동일한 100 MHz Pure RTL의 post-implementation vectorless 추정전력은 Total/Dynamic/Static 0.183/0.085/0.097 W이며, Total energy는 0.006590360700 J/decision, active dynamic energy는 0.003061096500 J/decision의 DERIVED_ESTIMATE다. 기존 1 MHz Pure RTL 0.099 W는 별도 저주파 power-only 근거이고 100 MHz latency와 곱하지 않는다. MicroBlaze system 0.271 W 역시 ESTIMATED power-only이며 physical board input power는 외부 전력계가 없어 미측정이다.
