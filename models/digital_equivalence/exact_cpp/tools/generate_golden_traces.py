...
def build(worker:int)->Path:
    ...
    sources=[DIGITAL_ROOT/"rtl/core"/n for n in CORE]+[DIGITAL_ROOT/"rtl/final_membrane_layer.v",DIGITAL_ROOT/"rtl/snn_ecg_30min_final_top.v",EXACT/"tools/tb_exact_cpp_snapshot_trace.v"]
