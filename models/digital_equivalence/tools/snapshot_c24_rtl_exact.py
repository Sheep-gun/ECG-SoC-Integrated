...
CLASS_SCORE_RTL = DIGITAL_ROOT / "rtl" / "core" / "class_score_neurons.v"
...
# The locked v2 RTL removed the historical EERG score injections.  The
# historical cycle model still executes those call sites, so map the removed
# vectors to zero to mirror the current locked class_score_neurons.v.
for _removed_base in ("C24_W_EERG_GATE", "C24_W_EERG_APPLIED", "C24_W_GATE_EERG_LIKE"):
    for _removed_cls in CLASSES:
        _CLASS_CONSTS.setdefault(f"{_removed_base}_{_removed_cls}", 0)
