...
RESULTS = REPO / "models" / "digital_equivalence" / "results" / "historical_final_membrane_v2_snn"
...
GIT_CANDIDATES = [Path(os.environ["GIT_EXE"])] if os.environ.get("GIT_EXE") else []
git_on_path = shutil.which("git")
if git_on_path:
    GIT_CANDIDATES.append(Path(git_on_path))
