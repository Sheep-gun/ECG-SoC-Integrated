...
- 2.991071 µW를 현재 FPGA 소비전력, 실측값 또는 AFE·메모리·MCU·통신을 포함한 전체 wearable 전력으로 표현하는 문장
