...
| 최종 고정 RTL | `c6b80de19cdcad5b7e43fe7835588b629d847f75` | 최종 구현·XSim·FPGA replay 근거 | integrated component와 `reports/final/final_metrics.json` |
...
- `components/digital_accelerator/reports/final/final_metrics.json`
