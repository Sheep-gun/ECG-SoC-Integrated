...
- digital benchmark commit `d44e675...`의 36-case measured counters, derived 100 MHz active-core timing, real-ECG SAIF 기반 100 MHz accelerator power 및 분리된 1 MHz/system vectorless estimate 반입 완료; routed-net SAIF match는 약 12%이고 integrated-system timing과 physical board input power는 미측정
