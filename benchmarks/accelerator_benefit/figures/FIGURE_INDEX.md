...
|---|---|---|---|---|
| 01_cpu_vs_rtl_latency | `benchmarks/accelerator_benefit/figures/01_cpu_vs_rtl_latency_source.csv` | Host and RTL stored-data latency | mixed, explicitly labeled | Python and RTL stored-data scopes are compared; C++ remains a generated RTL translation. |
