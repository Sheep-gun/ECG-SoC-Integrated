...
|---|---|---|---|---|
| 01_cpu_vs_rtl_latency | `benchmarks/accelerator_benefit/figures/01_cpu_vs_rtl_latency_source.csv` | CPU versus RTL stored-data latency | mixed, explicitly labeled | CPU latency and speedup are intentionally absent. |
