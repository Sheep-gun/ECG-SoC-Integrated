...
set result_dir [file normalize [file join $script_dir "results" "pure_rtl_100mhz"]]
set project_dir [file normalize [file join $work_dir "project"]]
set top_name "snn_ecg_v2_nexys_a7_100mhz_top"
set part_name "xc7a100tcsg324-1"
set constraint_file [file normalize [file join $script_dir "constraints" "nexys_a7_snn_ecg_v2_100mhz.xdc"]]

file mkdir $work_dir
file mkdir $result_dir
create_project -force SNN_ECG_PURE_RTL_100MHZ_POWER $project_dir -part $part_name
...
set rtl_files [list \
    ...
    [file normalize [file join $script_dir "sources" "snn_ecg_v2_nexys_a7_100mhz_top.v"]] \
]
...
open_run impl_1
report_utilization -file [file join $result_dir "pure_rtl_100mhz_utilization_post_route.rpt"]
report_timing_summary -delay_type min_max -check_timing_verbose -max_paths 50 -file [file join $result_dir "pure_rtl_100mhz_timing_post_route.rpt"]
report_power -file [file join $result_dir "pure_rtl_100mhz_power_post_route.rpt"]
write_checkpoint -force [file join $work_dir "pure_rtl_100mhz_routed.dcp"]
...
set env_file [open [file join $result_dir "pure_rtl_100mhz_environment.txt"] "w"]
...
puts $env_file "CORE_CLOCK_CONFIGURATION=Direct 100 MHz board clock; no generated or divided core clock"
