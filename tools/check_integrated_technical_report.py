...
def main() -> int:
    ...
    for term in [
        ...
        "29/36=80.56%", "36/36", "Nexys A7-100T", "36.012900 ms", "49.362861641×", "0.149500/0.052500/0.097000 W",
    ]:
    ...
    for term in [
        "d44e675", "최종 예측 36/36", "네 막전위 144/144", "Snapshot 경계 1,080/1,080",
    ...
    check("benchmark commit exact", benchmark["upstream_commit"] == "d44e67517650f1f95ca67b93c2788f41e99f1a5e")
