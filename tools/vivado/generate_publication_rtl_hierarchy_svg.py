...
ARTIFACTS = ROOT / "artifacts" / "rtl_elaborated_schematic"
SOURCE_TOP = ARTIFACTS / "FIG-RTL-A_top_hierarchy.svg"
SOURCE_SNAPSHOT = ARTIFACTS / "FIG-RTL-B_snapshot_core_hierarchy.svg"
APPROVED_SVG = ROOT / "figures" / "source" / "approved_svg" / "FIG-RTL_top_with_snapshot_expansion.svg"
OUTPUT_SVG = ROOT / "figures" / "final" / "FIG-RTL_top_with_snapshot_expansion.svg"
OUTPUT_PNG = ROOT / "figures" / "final" / "FIG-RTL_top_with_snapshot_expansion.png"
...
def build_svg() -> str:
    ...
    parts.append(
        ...
        f'artifacts/rtl_elaborated_schematic/FIG-RTL-A_top_hierarchy.svg and '
        f'artifacts/rtl_elaborated_schematic/FIG-RTL-B_snapshot_core_hierarchy.svg; '
