...
REQUIRED_FILES = [
    ...
    "reports/final/analog_validation_result.md",
    "reports/final/figures/FIGURE_INDEX.md",
    "reports/final/figures/analog_validation/FIGURE_INDEX.md",
    "reports/final/figures/analog_validation/01_analog_afe_architecture.svg",
    "reports/final/figures/analog_validation/02_ltspice_xmodel_aligned_schematic.jpg",
    "reports/final/figures/analog_validation/03_matlab_ltspice_afe_response.png",
    "reports/final/figures/analog_validation/04_matlab_ltspice_notch_response.png",
    "reports/final/figures/analog_validation/05_xmodel_ltspice_adc_waveform_full.png",
    "reports/final/figures/analog_validation/06_xmodel_ltspice_adc_waveform_zoom.png",
    "reports/final/figures/analog_validation/07_xmodel_ltspice_adc_error.png",
    "reports/final/figures/analog_validation/08_xmodel_ltspice_adc_error_histogram.png",
    "reports/final/figures/analog_validation/09_xmodel_ltspice_adc_agreement.png",
    "reports/final/figures/analog_validation/10_xmodel_ltspice_adc_metrics.png",
...
def check_digital_scope_and_handoff(failures: list[str]) -> None:
    ...
    required_texts = {
        ...
        "FINAL_REPORT_KR.md": [
            ...
            "MATLAB AFE+ADC nominal pre-validation",
            "XMODEL AFE+ADC verification",
            "LTspice XMODEL-aligned schematic verification",
            "Analog AFE+ADC Verification and Digital Input Contract",
            "sample_gap_cycles=2",
            "Digital full-top XSim expected outputs",
            "Vitis/MicroBlaze board replay vs expected outputs",
            "AFE-to-locked RTL integration evidence",
        ],
        "docs/PAPER_SUMMARY_KR.md": [
            "MATLAB 사전설계",
            "LTspice 실제 schematic 검증",
        ...
        "docs/SYSTEM_ARCHITECTURE_KR.md": [
            "MATLAB AFE pre-design",
            "LTspice schematic verification",
            "SystemVerilog AFE+ADC XMODEL",
            "Upstream AFE Dependency and Digital Input Handoff",
            "디지털 구현 경계는 signed 12-bit stream 이후",
