...
def main():
    ...
    files=[ROOT/"schematics/xmodel_aligned/FULL_AFE_ADC_SH_xmodel_aligned.asc",ROOT/"schematics/xmodel_aligned/FULL_AFE_ADC_SH_xmodel_aligned.net",ROOT/"schematics/xmodel_aligned/XOpAmp_XMODEL.lib",ROOT/"results/xmodel_aligned/nominal/ltspice_xmodel_aligned_adc_samples.csv",ROOT/"results/xmodel_aligned/nominal/ltspice_xmodel_aligned_direct_adc_signed.mem",ROOT/"results/xmodel_aligned/nominal/ltspice_track_hold_adc_signed.mem"]
