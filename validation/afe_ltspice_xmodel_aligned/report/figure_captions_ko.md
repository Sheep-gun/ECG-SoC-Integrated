...
동일 10초 입력, ECG+=patient/ECG-=0, 첫 1 ms falling-edge aperture에서 LTspice S/H signed code와 fixed XMODEL output을 비교하였다. 10,000 sample 기준 MAE 0.6445 LSB, correlation 0.999518, lag 0, clipping 0이며 98.74%가 ±5 LSB, 99.89%가 ±10 LSB 이내다. 결과 plot은 `../../../reports/final/figures/analog_validation/`에 보존한다.
