...
최종 모델은 `structural_guarded_silent_af_1008710`이다. Snapshot parameter는 고정했고, Final Membrane candidate는 train/validation만 사용해 선택했다. Locked final test records는 model selection, parameter search, ChatGPT context에 사용하지 않았다.
...
| Final test chunk class recall | NSR 100.00%, CHF 66.67%, ARR 77.78%, AF 77.78% |
