...
|---|---|---|---|---|
| Python golden fixed model | 0.000025 s | 40087.25 | 72157047680.29 | Local Python final-readout inference on precomputed chunk features, 3 repeats; best=0.003288s. Not raw-sample CPU processing. |
...
- Python fixed-model accuracy over all chunks: 125/136 = 91.91%
- RTL cycles/sample total: 1.000267
- Energy/sample status: Vivado-estimated @1MHz: 101.03 nJ/sample using 0.101 W total on-chip power.
