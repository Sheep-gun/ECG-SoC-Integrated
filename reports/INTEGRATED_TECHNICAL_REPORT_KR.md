...
*그림 12. signed ECG에서 변화량·강한 변화 사건·QRS LIF를 만든 뒤, 위쪽 박동·리듬 경로와 아래쪽 파형 형태 경로로 분기한다. RR/PNN/RDM/ectopic 증거와 DSCR/RAM/QRS MAF/RBBB-like 증거는 60초 Snapshot에서 합류하고, Final Membrane이 NSR·CHF·ARR·AFF 기록 클래스를 판정한다. 실제 합성 netlist 배선을 뜻하지 않는다.*
